...
License  : MIT
Requires: azure-mgmt-advisor-python = %{version}-%{release}
Requires: azure-mgmt-advisor-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-advisor package.
Group: Default
Requires: azure-mgmt-advisor-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-advisor package.


%package python3
Summary: python3 components for the azure-mgmt-advisor package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_advisor)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-advisor package.


%prep
%setup -q -n azure-mgmt-advisor-4.0.0
cd %{_builddir}/azure-mgmt-advisor-4.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588787747
